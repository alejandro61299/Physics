...
bool ModulePhysics3D::Start()
{
	...
	btBoxShape *shape = new btBoxShape(btVector3(100.0f, 10.0f, 100.0f));
...
update_status ModulePhysics3D::Update(float dt)
{
	...
	if(debug == true)
	{
		...
		if(App->input->GetKey(SDL_SCANCODE_1) == KEY_DOWN)
		{
			...
			btSphereShape *shape = new btSphereShape(5);
			btRigidBody::btRigidBodyConstructionInfo rigidBodyInfo(5.0f, motionState, shape);
			btRigidBody *rigidBody = new btRigidBody(rigidBodyInfo);
			world->addRigidBody(rigidBody);
		}
	}
